...
public class SimpleBookShelfPresenter extends BasePresenterImpl<SimpleBookShelfContract.View> implements SimpleBookShelfContract.Presenter {
    ...
    @Subscribe(thread = EventThread.MAIN_THREAD,
            tags = {@Tag(RxBusTag.HAD_ADD_BOOK), @Tag(RxBusTag.HAD_HIDDEN_BOOK), @Tag(RxBusTag.HAD_REMOVE_BOOK), @Tag(RxBusTag.UPDATE_BOOK_PROGRESS)})
