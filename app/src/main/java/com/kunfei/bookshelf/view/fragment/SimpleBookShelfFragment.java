...
import com.kunfei.bookshelf.presenter.SimpleBookShelfPresenter;
import com.kunfei.bookshelf.presenter.contract.MyBookListContract;
import com.kunfei.bookshelf.presenter.contract.SimpleBookShelfContract;
...
public class SimpleBookShelfFragment extends MBaseFragment<SimpleBookShelfContract.Presenter> implements SimpleBookShelfContract.View {
    ...
    public int createLayoutId() {
        return R.layout.f_simple_bookshelf;
    }

    @Override
    protected SimpleBookShelfContract.Presenter initInjector() {
        return new SimpleBookShelfPresenter();
    }

    @Override
    protected void initData() {
       // SimpleBookShelfFragment.CallBackValue callBackValue = (SimpleBookShelfFragment.CallBackValue) getActivity();
