...
public class ChapterListAdapter extends RecyclerView.Adapter<ChapterListAdapter.ThisViewHolder> {
    ...
    public ChapterListAdapter(Context context, BookShelfBean bookShelfBean, List<BookChapterBean> allChapter, @NonNull OnItemClickListener itemClickListener) {
    ...
    public ThisViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        normalColor = context.getResources().getColor(R.color.tv_text_secondary);
